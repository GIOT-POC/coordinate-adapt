    ...
    combinations.forEach(function(combDataArray) {
        ...
        dbClient.search({
            ...
            // Generate new document
                ...
                docID =  position.GPS_N.replace('.', '') + '-' + position.GPS_E.replace('.', '') + '_' + hashString(sigStr);
                ...
                for (var idx in combDataArray) {
                    ...
                    if (combDataArray[next]) {
                        body['diff_' + idx] = combDataArray[next].signal - combDataArray[idx].signal;
                    }
                }
